...
public class User  implements java.io.Serializable {
    ...
    public User(int userId, String fname, String lname, String email, String passward, String phone, String address) {
        this.userId = userId;
        this.fname = fname;
        this.lname = lname;
        this.email = email;
    ...
    public User(int userId, String fname, String lname, String email, String passward, String phone, String address, Set<Roles> roleses, Set<Product> products, Set<Orders> orderses) {
       this.userId = userId;
       this.fname = fname;
       this.lname = lname;
       this.email = email;
    ...
    @Column(name="passward", nullable=false, length=15)
